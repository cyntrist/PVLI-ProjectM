...
function CheckConditions(condicion, PM) { 
	let affVal = PM.affinities[condicion.charNum.value]; //afinidad del personaje a mirar, charNum es un parametro del nodo de condicion pero que no se evalua, solo es para guardar informacion
